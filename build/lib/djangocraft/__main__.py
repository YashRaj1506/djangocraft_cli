...
def djangostart(project_name: str, auth_app_name: str):
    ...
    if result.returncode == 0:
        ...
        shutil.copyfile("for_forms.txt", f"{destination_forms}")
        ...
        shutil.copyfile("for_views.txt", f"{destination_views}")
        shutil.copyfile("for_models.txt", f"{destination_models}")
        shutil.copyfile("for_urls.txt", f"{destination_urls}")
        ...
        shutil.copyfile("for_basehtml.txt",f"{destination_base}")
        shutil.copyfile("for_homehtml.txt", f"{destination_home}")
        shutil.copyfile("for_loginhtml.txt", f"{destination_login}")
        shutil.copyfile("for_registerhtml.txt", f"{destination_register}")
        ...
        shutil.copyfile("for_forms_backup.txt", "for_forms.txt")
